...
\section{Experience}
\vspace{-2mm}
%Include the word data analytics
\subsection{Work}
\cventry{2013--2014}{Associate Software Developer}{SAP Labs India}{Visualization Recommendation Team}{Bangalore}{I procured an employment as part of the Business Intelligence Team (of 22 members) at SAP Labs,India. I worked on a tool - Lumira (used by data analysts) which deals with vivid efficient visualizations of large input data sets focused on business economics.  I work in a sub-team which analyses the input data and provides insights for it and recommends the most suitable visualizations. I have gotten exposed to Model-View-Controller software pattern of coding and writing efficient reusable codes.I have gotten introduced to the field of modern data analysis algorithms and techniques - which I find whets my academic interest. Working in a supportive corporate environment has also improved my teamwork skills and discussion-for-consensus capabilities.}
...
\vspace{-3mm}
\subsection{An Agent to play duck hunt game using Hidden Markov Models(HMMs)}
...
%\subsection{Bot to play checkers using min max algorithm}
...
\cvline{}{\small I love any sport but I prefer Badminton and Table Tennis. I love social gathering and interested in spending time with people more. Love gaming and a big time NARUTO fan.}
