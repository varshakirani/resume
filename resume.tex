...
\section{References}
\subsection{\textbf{Prof Carl Henrik Ek}}
\cvitem{e-mail}{chek@csc.kth.se}
\cvitem{Telephone}{+46 8790 6245}
\cvitem{Link}{www.kth.se/profile/chek/}
\cvitem{Interaction}{I have taken a course under Carl Henrik called Machine Learning, Advanced. Guidelines from the Prof both during and after the course was very helpful. I understood the actual concept about gaussion process because of his lectures.}
\subsection{\textbf{Prof Hedvig Kjellström}}
\cvitem{e-mail}{hedvig@csc.kth.se}
\cvitem{Telephone}{+46 8790 6906}
\cvitem{Link}{www.kth.se/profile/hedvig/}
\cvitem{Interaction}{Prof Hedvig has taken two courses for me and guided me in a project required for advanced Machine Learning. Currently I have taken Search Engine and Information Retrieval course of hers where I started to develop interest towards information retrieva
\cvitem{e-mail}{sullivan@csc.kth.se}l more.}
\subsection{\textbf{Prof Josephine Sullivan}}
\cvitem{Telephone}{+46 8790 6136}
\cvitem{Link}{http://www.csc.kth.se/~sullivan/}
\cvitem{Interaction}{Prof Josephine is my Master Program co-ordinator. I have taken a theory and methodology of science course of hers where it changed my perspective about research and development in the science. In the coming term I have taken Image based Recognition and Analysis where I'll get exposed to computer vision.}
\end{document}